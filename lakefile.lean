...
lean_lib RiemannPNT where
  roots := #[
    ...
    `PrimeNumberTheorem.VKEdgeCosineModelAnnihilatorAverage,
    `PrimeNumberTheorem.VKEdgeResidualAmplificationNoGo,
    `PrimeNumberTheorem.VKEdgeZeroDensityResidualL2,
    `PrimeNumberTheorem.VKEdgeExplicitFormulaResidualBound,
    `PrimeNumberTheorem.VKEdgeZeroClusterResidual,
    `Test.VKEdgePiOverTwoFixedProportionContract,
    `Test.VKEdgePiOverTwoFixedProportionAxiomAudit,
    `PrimeNumberTheorem.VKEdgeArithmeticL2Converse,
    `Test.VKEdgeArithmeticL2ConverseContract,
    `PrimeNumberTheorem.LocalPsiL2ZeroCriterion,
    `Test.LocalPsiL2ZeroCriterionContract,
    `PrimeNumberTheorem.LocalPsiL2MellinCriterion,
    `Test.LocalPsiL2MellinCriterionContract,
    ...
    `Test.VKEdgeCosineModelAnnihilatorAverageContract,
    `Test.VKEdgeCosineModelAnnihilatorAverageAxiomAudit,
    `Test.VKEdgeResidualAmplificationNoGoContract,
    `Test.VKEdgeResidualAmplificationNoGoAxiomAudit,
    `Test.VKEdgeZeroDensityResidualL2Contract,
    `Test.VKEdgeZeroDensityResidualL2AxiomAudit,
    `Test.VKEdgeExplicitFormulaResidualBoundContract,
    `Test.VKEdgeExplicitFormulaResidualBoundAxiomAudit,
    `Test.VKEdgeZeroClusterResidualContract,
