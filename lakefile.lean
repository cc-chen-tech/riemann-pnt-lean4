...
lean_lib RiemannPNT where
  roots := #[
    ...
    `PrimeNumberTheorem.VKEdgeTargetPairAnnihilator,
    `PrimeNumberTheorem.VKEdgeTargetPairAnnihilatorAverage,
    ...
    `Test.VKEdgeTargetPairAnnihilatorAverageContract,
    `Test.VKEdgeTargetPairAnnihilatorAverageAxiomAudit,
