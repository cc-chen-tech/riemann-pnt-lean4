...
/-! The actual mean-square integral replaces the left logarithmic integral
without any mean-square asymptotic assumption or left-edge nonvanishing. -/
...
example :
  ...
  exact exists_conrey_selected_heights_simpleZeroCount_lower_bound_meanSquare

#print axioms exists_conrey_selected_heights_simpleZeroCount_lower_bound_meanSquare
