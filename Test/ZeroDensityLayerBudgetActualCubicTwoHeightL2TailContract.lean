...
example (beta sigma tau gamma : ℝ) :
    cubicCarlsonL2BlockExponent beta sigma tau gamma =
      2 * (tau - beta) +
        gamma * (carlsonTwoHeightDensityExponent sigma - 6) := rfl
