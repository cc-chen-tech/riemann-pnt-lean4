...
solution count. -/
theorem sum_incompleteVinogradovSolutionSelector_eq_count
    (Q h d s X : ℕ) [NeZero Q] :
...
power-sum window. -/
theorem incompleteVinogradovTuplePhaseMod_eq_sum_powerSum
    (Q h : ℕ) {d s X : ℕ}
...
theorem incompleteVinogradovTuplePhaseMod_sub_eq
    (Q h : ℕ) {d s X : ℕ}
...
coefficient pairing. -/
theorem stdAddChar_incompleteTuple_mul_neg_tuple
...
solution selector. -/
theorem normalized_sum_incompleteTuplePair_eq_selector
    (Q h d s X : ℕ) [NeZero Q]
    (x y : Fin s → Fin X) :
    (Q : ℂ)⁻¹ ^ d *
        ∑ a : Fin d → ZMod Q,
...
ordered tuple. -/
theorem incompleteVinogradovWeylSumMod_pow
    (Q h d s X : ℕ) [NeZero Q]
    (a : Fin d → ZMod Q) :
...
theorem conj_incompleteVinogradovWeylSumMod_pow
    (Q h d s X : ℕ) [NeZero Q]
    (a : Fin d → ZMod Q) :
...
theorem incompleteVinogradovPowerSumMod_one_eq
...
theorem incompleteVinogradovPhaseMod_one_eq
...
sum. -/
theorem incompleteVinogradovWeylSumMod_one_eq
