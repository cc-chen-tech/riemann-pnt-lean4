...
Adapted from rwst/lean-code commit d9d838819277fc2d8bd2b0ee09c773f1402a7aa6.
The only compatibility change before namespacing is the Mathlib import path.
-/
module
...
`L² · ‖∑_{n=1}^N uₙ‖² ≤ L (N + a(L-1)) · ∑_{n=1}^N ‖uₙ‖²`
`  + 2 (N + a(L-1)) · ∑_{ℓ=1}^{L-1} (L-ℓ) · Re ∑_{n=1}^{N-aℓ} uₙ · conj(u_{n+aℓ})`. -/
theorem vanDerCorputFundamentalInequality (a N : ℕ) (ha : 0 < a) (u : ℕ → ℂ) (L : ℕ)
    (hL : 1 ≤ a * L) (hLN : a * L ≤ N) :
