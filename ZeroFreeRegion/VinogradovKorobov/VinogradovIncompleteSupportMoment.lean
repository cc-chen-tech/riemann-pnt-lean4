...
private theorem incompleteSolutionSelectorOnMod_eq_indicator
    (Q h d s : ℕ) {ι : Type*} [Fintype ι] [NeZero Q]
...
private theorem sum_incompleteSolutionSelectorOnMod_eq_count
    (Q h d s : ℕ) {ι : Type*} [Fintype ι] [NeZero Q]
    (value : ι → ZMod Q) :
    ∑ x : Fin s → ι, ∑ y : Fin s → ι,
      incompleteSolutionSelectorOnMod Q h d s value x y =
...
retained power sums. -/
private theorem incompleteTuplePhaseOnMod_eq_sum_powerSum
    (Q h : ℕ) {ι : Type*} [Fintype ι]
    (value : ι → ZMod Q) {d s : ℕ}
...
private theorem incompleteTuplePhaseOnMod_sub_eq
    (Q h : ℕ) {ι : Type*} [Fintype ι]
    (value : ι → ZMod Q) {d s : ℕ}
...
coefficient pairing. -/
private theorem stdAddChar_incompleteTupleOn_mul_neg_tuple
...
private theorem normalized_sum_incompleteTuplePairOn_eq_selector
    (Q h d s : ℕ) {ι : Type*} [Fintype ι] [NeZero Q]
    (value : ι → ZMod Q) (x y : Fin s → ι) :
    (Q : ℂ)⁻¹ ^ d *
        ∑ a : Fin d → ZMod Q,
...
private theorem incompleteWeylSumOnMod_pow
    (Q h d s : ℕ) {ι : Type*} [Fintype ι] [NeZero Q]
    (value : ι → ZMod Q) (a : Fin d → ZMod Q) :
...
private theorem conj_incompleteWeylSumOnMod_pow
    (Q h d s : ℕ) {ι : Type*} [Fintype ι] [NeZero Q]
    (value : ι → ZMod Q) (a : Fin d → ZMod Q) :
...
private theorem incompletePowerSumOnMod_interval_eq
    (Q h : ℕ) {d s X : ℕ}
...
private theorem incompletePhaseOnMod_interval_eq
    (Q h : ℕ) {d X : ℕ}
...
private theorem incompleteWeylSumOnMod_interval_eq
