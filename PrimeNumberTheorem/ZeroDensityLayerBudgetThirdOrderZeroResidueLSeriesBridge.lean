...
theorem exists_thirdOrderExplicitZeroPoleFormula_secondSmoothedPsi_error_le
    ...
    ∃ (poles : Finset ℂ) (residue : ℂ → ℂ) (cubic : ℂ),
      ...
      residue 0 = iteratedDeriv 2 (ExplicitFormulaResidues.thirdOrderZeroCore x) 0 / 2 ∧
  ...
  obtain ⟨poles, residue, cubic, h0mem, hpoles, hpolesType,
      hresidue, hresidue0, hcubic, hcontour⟩ :=
    ExplicitFormulaResidues.exists_scaledRightIntegral_eq_explicitZeroPoleResidue_sum_sub_thirdOrderContourRemainder
      hx ha hc0 hW hboundary
  refine ⟨poles, residue, cubic, h0mem, hpoles, hpolesType,
    hresidue, hresidue0, hcubic, ?_⟩
  have hright :
      (∫ w : ℝ in -W..W,
