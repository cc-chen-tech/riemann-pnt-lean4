...
This module implements the L1 detection-point choice checkpoint.

The interval covering lemma, the windowed-count estimates, and the main
detection-point assembly are proved here.  Their dependencies are tracked by
`Test/DetectionPointChoiceAxiomAudit.lean`.
-/
