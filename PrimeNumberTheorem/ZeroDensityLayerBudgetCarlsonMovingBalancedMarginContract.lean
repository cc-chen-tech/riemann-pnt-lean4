...
#check carlsonTwoHeightDensityExponent_one_sub_two_mul_bounds
#check carlsonTwoHeightBalancedPenalty_one_sub_two_mul_le
#check carlsonTwoHeightBalancedExponent_movingStrip_le_neg_half
#check one_sub_lt_carlsonTwoHeightBalancedTauCeiling_movingStrip
#check eventually_carlsonTwoHeightBalancedExponent_movingStrip_le_neg_half
