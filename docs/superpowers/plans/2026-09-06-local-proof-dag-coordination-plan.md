...
- [x] **Step 1: Define the manifest schema and graph nodes**
...
- [x] **Step 2: Check node and edge counts manually**
...
- [x] **Step 1: Add deterministic Mermaid generation**
...
- [x] **Step 3: Add a run-record template**
...
- [x] **Step 2: Run the DAG validator and generator**
...
- [x] **Step 4: Commit the isolated implementation**
