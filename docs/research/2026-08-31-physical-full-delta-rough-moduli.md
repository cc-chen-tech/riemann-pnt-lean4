...
取 Y→∞，由 Bertrand 定理选互异素数 e≍Y^687、p≍Y^481、r≍Y^482。
令 s=epr、R=S=s、N=8s、T=N^(1/3)≍Y^550、M=K=√T；
取 n 为 (s,2s) 内素数。则 q=pr 为 rough 合数，e≍T^(687/550)。
...
有限脚本还保留 T=10^6、M=K=1000、e=10000019、p=100003、r=100019、
s=100022190611801083、n=100022190611801131、x=750 的精确整数例。
q 的两个素因子都大于 B=8000，所有原 core、gcd、mollifier 支持及
e^550≤T^687≤(4e)^550 均经整数／有理核对。
