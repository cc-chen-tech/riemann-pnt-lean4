...
- Compare multiple zero-pair cutoffs in a truncation-sensitivity table.
...
2. Add externally loaded zero fixtures with provenance notes.
3. Add CSV export for Li coefficient and sensitivity tables.
