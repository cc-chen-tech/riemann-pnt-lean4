...
| `ZeroFreeRegion.classical_zero_free_region_of_exists_regular_part_bound_and_two_t_bound` | `lemma` | Existentially packages the regular-part bound and the `σ+2it` bound under one nonnegative logarithmic coefficient. | Current narrowest conditional interface for the quantitative zero-free-region chain. |
