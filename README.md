...
| `ZeroFreeRegion.classical_zero_free_region_of_exists_neg_logDeriv_regular_part_norm_bounds` | `lemma` | Existential two-coefficient version of the same `-logDeriv ζ` norm-bound closure. | Most flexible caller-facing conditional interface for the quantitative zero-free-region path. |
