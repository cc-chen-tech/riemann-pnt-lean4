...
| `ZeroFreeRegion.classical_zero_free_region_of_exists_neg_logDeriv_regular_part_norm_bound_and_vertical_logDeriv_norm_bound` | `lemma` | Existential version of the regular-part plus vertical-strip norm estimate closure. | Current highest-level conditional interface for the quantitative zero-free-region path. |
