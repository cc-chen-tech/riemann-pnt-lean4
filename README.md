...
| `ZeroFreeRegion.classical_zero_free_region_of_exists_neg_logDeriv_regular_part_norm_bound_and_two_t_bound` | `lemma` | Existential `-logDeriv ζ` notation wrapper for the same norm-bound input. | Tightest caller-facing conditional interface for the quantitative zero-free-region path. |
