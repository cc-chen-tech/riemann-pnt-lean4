...
| `ZeroFreeRegion.classical_zero_free_region_of_exists_regular_part_norm_bound_and_two_t_bound` | `lemma` | Existentially packages the norm regular-part bound and the `σ+2it` bound under one nonnegative logarithmic coefficient. | Final conditional bridge before proving the zeta-specific norm/log-derivative estimates. |
