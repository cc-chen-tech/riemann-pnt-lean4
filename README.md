...
| `ZeroFreeRegion.classical_zero_free_region_of_exists_neg_logDeriv_regular_part_norm_and_two_t_norm_bounds` | `lemma` | Existential fully norm-bound version with separate nonnegative coefficients. | Current most analysis-facing conditional interface for the quantitative zero-free-region path. |
