...
- center-one finite zero-pair positivity bridges, average finite-zero
  contribution nonnegativity, new-zero block reflection/reindexing, and
...
| `RiemannPNT.API.log_deriv_zeta_bty_detector_one_lower_bound_of_uniform_right_shift_borel_family` / `..._uniform_signed_right_shift_borel_family` | `theorem` | Uniform-bound version of the BTY right-shifted Borel bridge using the computed remaining-coefficient sum `6917296 / 2485395`. | Gives the later zero-free-region route the cleaner one-constant upper-bound interface expected from global height comparisons. |
