...
MATH_TARGETS = {
    "FiniteSpectrumGap.finiteSpectrumGapTarget": "Quantitative zero-free region",
    "FiniteSpectrumGap.kappaFormTarget": "Quantitative zero-free region",
    ...
    "HardyTheorem.selberg_odd_zero_proportion_target": "Quantitative critical-line extensions",
...
REUSABLE_PREDICATES = {
    ...
    "LogDerivZetaIsHoloSmall",
    "RectangleBorderIntegrable",
    "HasSimplePolesOn",
    "Zeta23.MuInts.StirlingHyp",
    "Zeta23.ExplicitFormulaPaper",
    "Zeta23.MVHilbert",
    "RHLinalg.PosDefOn",
    "Zeta23.MV.EigenBound",
    "Zeta23.MVDiag",
    "Zeta23.PairCeiling.NearCUE",
    "Zeta23.PrimeSide.EventuallyAt",
    "EventuallyAtCore",
    "Zeta23.PrimeSide.NuBound",
    "Zeta23.PrimeSide.LocalHypsEventually",
    "Zeta23.EvBound",
    "Zeta23.ThmTracesHyp",
    "Zeta23.RvM.GoodHeight",
    "Zeta23.IsNontrivialZero",
    "ThmA_statement",
    "ThmB_statement",
    "ThmC_statement",
    "Zeta23.Tail.InTail",
    "Zeta23.ThmD.LocalHypsCoreDEventually",
    "Zeta23.ThmE.EF_lit_chi",
    "Zeta23.ThmE.ExplicitFormulaPaperChi",
    "Zeta23.ThmE.GoodHeightL",
    "Zeta23.ThmE.IsNontrivialZeroL",
    "Zeta23.ThmE.ThmTracesHypChi",
    "Zeta23.ThmTracesHypE",
    "Zeta23.XiPrime.IsXiDerivZero",
    "Zeta23.XiPrime.IsWZero",
    "Zeta23.XiPrime.FullLineIdentity",
    "Zeta23.XiPrime.RationalLine",
    "Zeta23.XiPrime.CoeffFacts",
    "Zeta23.XiPrime.TestWeightFacts",
    "Zeta23.XiPrime.Hardy.GoodHeightW",
    "Zeta23.XiPrime.WFullLineIdentityWith",
    "Zeta23.XiPrime.WFullLineIdentity",
    "Zeta23.XiPrime.LminusLineIdentity",
    "Zeta23.XiPrime.LineFactsW",
    "Zeta23.XiPrime.ContourFactsW",
    "Zeta23.XiPrime.CoeffFactsC",
    "Zeta23.XiPrime.PPInput",
    "Zeta23.XiPrime.AdmFamily",
    "Zeta23.MomentsW",
    "Zeta23.XiPrime.XiZerosAreZetaZeros",
    "Zeta23.XiPrime.XiDerivZerosInStrip",
    "Zeta23.XiDerivRvM",
    "Zeta23.D1Summable",
    "Zeta23.XiEF",
    "Zeta23.XiTraceTransfer",
    "Zeta23.CoeffMoments",
    "Zeta23.GzMoments",
    "Zeta23.CertFlat",
    "Zeta23.CertQuartic",
    "Zeta23.FixedLamBounds",
    "Zeta23.HeadlineFlat",
    "Zeta23.HeadlineQuartic",
    "Zeta23.HeadlineCumulative",
    "Zeta23.WZerosInStrip",
    "HeadlineW",
    "Zeta23.XiPrime.WEF",
    "Zeta23.XiPrime.WRvM",
    "Zeta23.XiPrime.PPUpper",
    "Zeta23.XiPrime.HatNegligible",
    "Zeta23.XiPrime.ZeroCount.GoodHeight",
    ...
    "PrimeNumberTheorem.ZeroDensityMajorant",
    "PrimeNumberTheorem.AdmissibleHeight",
    "PrimeNumberTheorem.IsOptimalHeight",
    "PrimeNumberTheorem.HasFarNormWitness",
    "PrimeNumberTheorem.HasFarPositiveWitness",
    ...
    "PrimeNumberTheorem.HasFarNaturalPointPositiveTargetAmplitudeWitness",
    "PrimeNumberTheorem.HasFarNaturalPointNegativeTargetAmplitudeWitness",
    ...
    "PrimeNumberTheorem.HasFarWindowEnergyBudgets",
    "PrimeNumberTheorem.HasFarWindowEnergySeparation",
    ...
    "PrimeNumberTheorem.PositiveOutsideClusterBucketFamilyAboveHalf",
    ...
    "PrimeNumberTheorem.HalfIsolatedZeroDichotomy.IsTopLayerZero",
    "PrimeNumberTheorem.HalfIsolatedZeroDichotomy.IsHalfIsolatedZero",
    "PrimeNumberTheorem.HalfIsolatedZeroDichotomy.IsInQuantitativeLocalCluster",
    "PrimeNumberTheorem.HalfIsolatedZeroDichotomy.HasHalfIsolatedDichotomy",
    "PrimeNumberTheorem.HalfIsolatedZeroDichotomy.HalfIsolatedSimplifiedDetectorInput",
    "PrimeNumberTheorem.HalfIsolatedZeroDichotomy.HalfIsolatedPureSimplifiedDetectorInput",
    "PrimeNumberTheorem.HalfIsolatedZeroDichotomy.HalfIsolatedResidualControlForDetector",
    "PrimeNumberTheorem.VKEdgeConditionalPackage.HalfIsolatedDirectedGrowth",
    "PrimeNumberTheorem.VKEdgeConditionalPackage.HalfIsolatedConclusion",
    "PrimeNumberTheorem.VKEdgeConditionalPackage.ClusteredConclusion",
    "PrimeNumberTheorem.VKEdgeConditionalPackage.HalfIsolatedDirectedGrowthPotential",
    "PrimeNumberTheorem.HalfIsolatedDetectorContractOutput",
    "PrimeNumberTheorem.HalfIsolatedDetectorAmplificationContract",
    "PrimeNumberTheorem.windowStartPairwiseSeparated",
    ...
    "PrimeNumberTheorem.ActualDynamicCarlsonGapFamilyHeightConditions",
    ...
    "PrimeNumberTheorem.IsCarlsonMovingQuadraticLogGap",
    "PrimeNumberTheorem.IsCarlsonMovingQuadraticLogPowerGap",
    "PrimeNumberTheorem.CarlsonPointwiseHeightConditions",
