...
EXPECTED_DECLARATIONS = {
    ...
    "PrimeNumberTheorem.ExplicitFormulaResidues.norm_intervalIntegral_desmoothedCubicLeftContourIntegrand_neg_le",
    "PrimeNumberTheorem.ExplicitFormulaResidues.norm_add_intervalIntegral_desmoothedCubicLeftContourIntegrand_le",
    "PrimeNumberTheorem.ExplicitFormulaResidues.exists_dynamicCubicLeftBoundary_negative_interval_oscillatory_bound",
