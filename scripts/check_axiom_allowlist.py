...
OSCILLATION_EXPECTED_DECLARATIONS = {
    ...
    "PrimeNumberTheorem.ZeroForcedOscillation.upperNaturalLogSample_mem_short_interval",
    "PrimeNumberTheorem.ZeroForcedOscillation.exp_upperNaturalLogSample",
    "PrimeNumberTheorem.ZeroForcedOscillation.two_le_upperNaturalLogSampleNat",
    "PrimeNumberTheorem.ZeroForcedOscillation.tendsto_upperNaturalLogSample_atTop",
