...
EXPECTED_DECLARATIONS = {
    ...
    "PrimeNumberTheorem.VKEdgePiOverTwo.frequencyAnnihilatorMultiplier_target",
    "PrimeNumberTheorem.VKEdgePiOverTwo.intervalIntegral_frequencyAnnihilatorMultiplier_sq",
