...
WEIL_RANK_TWO_TAIL_EXPECTED_DECLARATIONS = {
    ...
    "WeilExtremalKernels.analyticAt_Gamma_of_re_pos",
    "WeilExtremalKernels.analyticAt_digamma_of_re_pos",
    "WeilExtremalKernels.continuous_archimedeanHPlus",
    ...
    "WeilExtremalKernels.eventually_forall_L_quadraticForm_add_paperActualArchimedeanRankTwoTail_stable_of_common_exactLDL_interval",
    "WeilExtremalKernels.exists_T_forall_L_quadraticForm_add_paperActualArchimedeanRankTwoTail_stable_of_common_exactLDL_interval",
